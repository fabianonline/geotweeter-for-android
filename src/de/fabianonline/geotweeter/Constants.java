...
public class Constants extends Application {
	...
	public static final String URI_HOME_TIMELINE = "https://api.twitter.com/1/statuses/home_timeline.json";
	public static final String URI_MENTIONS = "https://api.twitter.com/1/statuses/mentions.json";
	public static final String URI_DIRECT_MESSAGES = "https://api.twitter.com/1/direct_messages.json";
	public static final String URI_DIRECT_MESSAGES_SENT = "https://api.twitter.com/1/direct_messages/sent.json";
	public static final String URI_UPDATE = "https://api.twitter.com/1/statuses/update.json";
