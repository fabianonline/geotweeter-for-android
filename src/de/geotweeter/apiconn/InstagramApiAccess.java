...
public class InstagramApiAccess {
	...
	/**
	 * Generates URLs for the thumbnail and full size images of a Instagram
	 * picture
	 * 
	 * @param url
	 *            URL from a tweet
	...
	public static Pair<URL, URL> getUrlPair(Url url)
		...
		return new Pair<URL, URL>(new URL("http://instagr.am/"
				+ screen_url.getPath() + "/media/?size=t"), new URL(
				"http://instagr.am/" + screen_url.getPath() + "/media/?size=l"));
	}
