...
public class Constants extends Application {
	...
	public static final String URI_GET_FRIEND_IDS = "https://api.twitter.com/1.1/friends/ids.json";
	public static final String URI_GET_FOLLOWER_IDS = "https://api.twitter.com/1.1/followers/ids.json";
	public static final String URI_LOOKUP_USERS = "https://api.twitter.com/1.1/users/lookup.json";
	...
	public static final Pattern REGEXP_FIND_SOURCE = Pattern
			.compile(">(.+)</a>");
	...
	public static final String ICON_PICTURES = "🌄";
	...
	public static enum RequestType {
		UNSPECIFIED, USER_TIMELINE, HOME_TIMELINE, MENTIONS, DM_SENT, DM_RCVD, SINGLE_TWEET, DELETE_DM, DELETE_TWEET, RETWEET, FAV, DEFAV, FOLLOW, UNFOLLOW, RELATIONSHIP, FOLLOWERS, FRIENDS, SINGLE_USER, BLOCK, UNBLOCK, REPORT_SPAM, FRIEND_IDS, FOLLOWER_IDS, CONFIG
	}
