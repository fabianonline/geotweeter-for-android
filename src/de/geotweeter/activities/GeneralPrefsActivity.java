		...
		tweetTime
				.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
					...
					public boolean onPreferenceChange(Preference preference,
							Object newValue) {
						ListPreference tweetTime = (ListPreference) findPreference("pref_tweet_time_style");
						preference.setSummary(tweetTime.getEntries()[tweetTime
						...
						try {
							((TimelineElementAdapter) TimelineActivity
									.getTimelineListView().getAdapter())
									.notifyDataSetChanged();
						} catch (NullPointerException e) {
							// May happen during first start
						}
						return true;
					}
				});
		...
		imageHoster
				.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
					...
					public boolean onPreferenceChange(Preference preference,
							Object newValue) {
						ListPreference imageHoster = (ListPreference) findPreference("pref_image_hoster");
						preference.setSummary(imageHoster.getEntries()[imageHoster
								.findIndexOfValue(newValue.toString())]);
						return true;
					}
				});
				...
				.setOnPreferenceClickListener(new OnPreferenceClickListener() {
					...
					public boolean onPreferenceClick(Preference preference) {
						...
						Toast.makeText(getApplicationContext(),
								R.string.pref_image_cache_cleared,
								Toast.LENGTH_SHORT).show();
						return true;
					}
				});

		findPreference("pref_dark_theme").setOnPreferenceChangeListener(
	...
	protected void onDestroy() {
		...
		if (themeChanged) {
			...
			new AlertDialog.Builder(TimelineActivity.getInstance())
					...
					.setPositiveButton(R.string.pref_theme_changed_positive,
							new OnClickListener() {
					...
					.setNegativeButton(R.string.pref_theme_changed_negative,
							null).show();
		}
	}
