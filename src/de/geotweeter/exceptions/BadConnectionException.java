...
public class BadConnectionException extends Exception {
	...
	public enum RequestType {
		UNSPECIFIED, USER_TIMELINE, HOME_TIMELINE, MENTIONS, DM_SENT, DM_RCVD, SINGLE_TWEET, DELETE_DM, DELETE_TWEET, RETWEET, FAV, DEFAV, FOLLOW, UNFOLLOW, RELATIONSHIP, FOLLOWERS, FRIENDS, SINGLE_USER, BLOCK, UNBLOCK
	}
